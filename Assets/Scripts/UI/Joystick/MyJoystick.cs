...
namespace MyGameFramework
{
    ...
    {
        [Header("摇杆类型")] public EJoystickType EJoystickType = EJoystickType.Fixed;

        public Camera uiCamera;

        [Header("摇杆背景")] public RectTransform BgRect;

        [Header("摇杆拖动按钮")] public RectTransform HandleRect;

        [Header("点击唤醒摇杆区域")] public RectTransform DragArea;
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            input = (eventData.position - position) /
                    (radius * mCanvas.scaleFactor); //将屏幕中的触点和background的距离映射到ui空间下实际的距离
        ...
        private Vector2 ScreenPointToAnchoredPosition(Vector2 screenPosition)
        {
            ...
            RectTransformUtility.ScreenPointToLocalPointInRectangle(mBaseRect, screenPosition, uiCamera,
                out localPoint);
            return localPoint;
        }
