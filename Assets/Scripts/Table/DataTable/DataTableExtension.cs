...
{
      private static string DataRowClassPrefixName => "Table.DR";
        ...
        public static void UnLoadDataTable(this DataTableComponent dataTableComponent, string dataTableName, string dataTableAssetName, object userData)
        {
            if (string.IsNullOrEmpty(dataTableName))
            {
                Log.Warning("Data table name is invalid.");
            ...
            string name = splitedNames.Length > 1 ? splitedNames[1] : null;
            dataTableComponent.DestroyDataTable(dataRowType, name);
        }

        public static bool HasDataTable(this DataTableComponent dataTableComponent, string dataTableName, string dataTableAssetName, object userData)
        {
            if (string.IsNullOrEmpty(dataTableName))
            {
                Log.Warning("Data table name is invalid.");
            ...
            string name = splitedNames.Length > 1 ? splitedNames[1] : null;
            return dataTableComponent.HasDataTable(dataRowType, name);
        }
